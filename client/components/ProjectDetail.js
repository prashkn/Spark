        ...
        >
            <ScrollView style={project.container}>
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <Pressable style={{ display: 'flex', justifyContent: 'center' }}>
                ...
                <View style={{ display: 'flex' }}>
                    ...
                    {onApplicants ? projectInfo.applicants.map((applicant, i) => (
                        <Applicant key={i} userId={applicant} navigation={navigation} />
                    ))
                        :
                        projectInfo.participants.map((applicant, i) => (
                            <Applicant key={i} userId={applicant} navigation={navigation} />
                        ))
                    }
                </View>
